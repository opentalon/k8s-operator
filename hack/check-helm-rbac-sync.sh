...
# (charts/opentalon-operator/templates/clusterrole.yaml).
#
...
HELM="charts/opentalon-operator/templates/clusterrole.yaml"
...
if [ -n "$MISSING" ]; then
  ...
  echo ""
  echo "Fix: update charts/opentalon-operator/templates/clusterrole.yaml to match"
