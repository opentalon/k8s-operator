#!/usr/bin/env bash
# hack/sync-chart-crds.sh - Sync CRDs from config/crd/bases/ to Helm chart templates.
#
...
CRD_DST="${REPO_ROOT}/charts/opentalon-operator/templates/crds"
...
generate_template() {
...

    {
        ...
        annotation_done == 1 && /^  name:/ {
            ...
            print $0
            print "  labels:"
            print "    {{- include \"opentalon-operator.labels\" . | nindent 4 }}"
            annotation_done=0
            next
        }
        { print }
